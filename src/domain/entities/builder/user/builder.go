...
func (b *UserBuilder) FromDTO(dto *userDTO.UserDTO) *UserBuilder {
...
func (b *UserBuilder) Build() (*userEntity.User, *exception.BuilderException) {
	err := b.validateUser()
	if err != nil {
		return nil, err
	}
	...
	if !b.isHashed(b.password) {
		hashedPassword, err := userEntity.HashPassword(b.password)
		if err != nil {
	...
	return userEntity.NewUser(b.username, b.password, b.email, b.lastname, b.firstname), nil
}
